...
from views.explore.explore import exploreWindow
from views.manage.manage import manageWindow
from views.notifications.notifications import notificationsWindow
from views.profile.profile import profileWindow
from views.settings.settings import settingsWindow
